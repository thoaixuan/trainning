...
<link href="<?php echo e(asset('themes/admin/assets/plugins/toastr/toastr.min.css')); ?>"/>
<link href="<?php echo e(asset('themes/guest/css/style.css')); ?>" rel="stylesheet" />

<style>
    :root {
        --primary-bg-color: <?php echo getConfigMail()->root_color; ?>;
    }
</style><?php /**PATH C:\teamcoder\www\trainning\sang_helper_ing\resources\views/Guest/partials/stylesheet.blade.php ENDPATH**/ ?>