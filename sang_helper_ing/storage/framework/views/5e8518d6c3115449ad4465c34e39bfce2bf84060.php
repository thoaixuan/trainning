...
var contact = new contact(); 
	    contact.datas={
	        routes:{
	            datatable:"<?php echo e(route('admin.contact.datatable')); ?>",
			    delete:"<?php echo e(route('admin.contact.delete')); ?>"
	        }
	    }   
contact.init();
</script>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH M:\2022-ING\trainning\helper.ecommerce_ing\resources\views/admin/pages/contact/index.blade.php ENDPATH**/ ?>