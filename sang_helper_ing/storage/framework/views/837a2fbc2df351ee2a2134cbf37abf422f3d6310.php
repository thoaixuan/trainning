        ...
        <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            ...
                            <img src="<?php echo e(url('/uploads').'/'.$header_logo->admin_logo_white); ?>" class="header-brand-img desktop-logo max-width-100" alt="logo">
                            <img src="<?php echo e(url('/uploads').'/'.$header_logo->admin_logo_blue); ?>" class="header-brand-img light-logo1 max-width-100"
                                alt="logo">
                                    ...
                                    <div class="d-flex order-lg-2">
                                                ...
                                                <div class="message-menu">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            data-bs-image-src="<?php echo e(asset('themes/admin/assets/images/users/1.jpg')); ?>"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="<?php echo e(asset('themes/admin/assets/images/users/15.jpg')); ?>"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="<?php echo e(asset('themes/admin/assets/images/users/12.jpg')); ?>"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="<?php echo e(asset('themes/admin/assets/images/users/4.jpg')); ?>"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                                <img src="<?php echo e(asset('themes/admin/assets/images/users/21.jpg')); ?>" alt="profile-user"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    <div class="text-center">
                                                        <h5 class="text-dark mb-0 fs-14 fw-semibold"><?php echo e(Auth::user()->email); ?></h5>
                                                        <small class="text-muted"><?php echo e(Auth::user()->name); ?></small>
                                                    </div>
                                                </div>
                                              
                                                <a class="dropdown-item" href="<?php echo e(route('admin.login.logout')); ?>">
            ...
            <!-- /app-Header -->
<?php /**PATH C:\teamcoder\www\trainning\sang_helper_ing\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>