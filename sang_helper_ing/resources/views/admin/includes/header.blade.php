                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            ...
                            <img src="{{url('/uploads').'/'.$header_logo->admin_logo_white}}" class="header-brand-img desktop-logo max-width-100" alt="logo">
                            <img src="{{url('/uploads').'/'.$header_logo->admin_logo_blue}}" class="header-brand-img light-logo1 max-width-100"
                                alt="logo">
                            @endforeach
                        </a>
                        <!-- LOGO -->
                                                ...
                                                <div class="message-menu">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            data-bs-image-src="{{asset('themes/admin/assets/images/users/1.jpg')}}"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{asset('themes/admin/assets/images/users/15.jpg')}}"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{asset('themes/admin/assets/images/users/12.jpg')}}"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{asset('themes/admin/assets/images/users/4.jpg')}}"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
