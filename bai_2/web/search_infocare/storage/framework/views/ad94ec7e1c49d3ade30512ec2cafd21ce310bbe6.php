    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 wow animated customFadeInLeft">
                <div class="news-block mb-30">
                    <div class="blog-thumb">
                        <img src="<?php echo e(asset('guest\assets\img\blog\home-blog1.png')); ?>" alt="news">
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 wow animated customFadeInUp">
                <div class="news-block mb-30">
                    <div class="blog-thumb">
                        <img src="<?php echo e(asset('guest\assets\img\blog\home-blog2.png')); ?>" alt="news">
                    </div>
                    <div class="news-inner">
            ...
            <div class="col-lg-4 col-sm-6 wow animated customFadeInRight">
                <div class="news-block mb-30">
                    <div class="blog-thumb">
                        <img src="<?php echo e(asset('guest\assets\img\blog\home-blog3.png')); ?>" alt="news">
                    </div>
                    <div class="news-inner">
...
</section><?php /**PATH C:\teamcoder\www\trainning\bai_2\web\search_infocare\resources\views/guest/pages/home/includes/blog.blade.php ENDPATH**/ ?>