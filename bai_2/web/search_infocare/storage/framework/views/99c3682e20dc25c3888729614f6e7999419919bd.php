        ...
        <div class="row">
            <div class="col-md-7">
                <div class="skill-note-img rmb-50">
                    <img class="skill-bg" src="<?php echo e(asset('guest\assets\img\skill\skill-bg.png')); ?>" alt="">
                    <img class="notpad" src="<?php echo e(asset('guest\assets\img\skill\skill-note.png')); ?>" alt="">
                    <img class="leaf" src="<?php echo e(asset('guest\assets\img\skill\leaf.png')); ?>" alt="">
                </div>
            </div>
...
</section><?php /**PATH C:\teamcoder\www\trainning\bai_2\web\search_infocare\resources\views/guest/pages/home/includes/skill-area.blade.php ENDPATH**/ ?>