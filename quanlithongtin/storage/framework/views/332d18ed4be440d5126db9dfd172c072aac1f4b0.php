    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open-new">
            <a href="<?php echo e(route('phongban')); ?>" class="nav-link ">
...
<?php /**PATH C:\laragon\www\trainning\quanlithongtin\resources\views/Admin/includes/sidebar.blade.php ENDPATH**/ ?>