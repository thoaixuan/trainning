...
<section class="content-header">
  ...
  <section class="content">
    ...
    <script src="<?php echo e(asset('app/admin/page/page.js')); ?>"></script>
<script>
  
var page = new page(); 
	    page.datas={
	        routes:{
	            datatable:"<?php echo e(route('page_datatable')); ?>",
              insert:"<?php echo e(route('page_insert')); ?>",
	            update:"<?php echo e(route('page_update')); ?>",
			        delete:"<?php echo e(route('page_delete')); ?>"
	        }
	    }   
	    page.init();
...
<?php $__env->stopSection(); ?>
  ...
  <!-- /.content -->
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\teamcoder\www\trainning\infocare\resources\views/Admin/pages/pages/pages.blade.php ENDPATH**/ ?>