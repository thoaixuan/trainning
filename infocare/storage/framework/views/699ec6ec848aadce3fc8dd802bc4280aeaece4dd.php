			...
			<div class="row">
				<div class="col-sm-12 col-md-6 col-lg-4 ">
					...
					<div class="small-box bg-primary">
						<div class="inner">
							<h5 id="countCustomers"><?php echo e(countUser()); ?></h5>
							<p>Tổng Thành Viên</p>
						</div>
				...
				<div class="col-sm-12 col-md-6 col-lg-4 ">
					...
					<div class="small-box bg-warning">
						<div class="inner">
							<h5 class="countPublished"><?php echo e(countProjects()); ?></h5> 
							<p>Tổng Dự án</p>
						</div>
				...
				<div class="col-sm-12 col-md-6 col-lg-4 ">
					...
					<div class="small-box bg-success">
						<div class="inner">
							<h5 class="countPending"><?php echo e(countServices()); ?></h5>
							<p>Tổng Dịch Vụ</p>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\teamcoder\www\trainning\infocare\resources\views/Admin/pages/dashboard/dashboard.blade.php ENDPATH**/ ?>