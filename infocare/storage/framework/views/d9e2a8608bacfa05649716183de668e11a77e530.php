...
<section class="content-header">
  ...
  <section class="content">
    ...
    <script src="<?php echo e(asset('app/admin/service/service.js')); ?>"></script>
<script>
  
var service = new service(); 
	    service.datas={
	        routes:{
	          datatable:"<?php echo e(route('service_datatable')); ?>",
            insert:"<?php echo e(route('service_insert')); ?>",
	          update:"<?php echo e(route('service_update')); ?>",
			      delete:"<?php echo e(route('service_delete')); ?>"
	        }
	    }   
	    service.init();
...
<?php $__env->stopSection(); ?>
  ...
  <!-- /.content -->
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\teamcoder\www\trainning\infocare\resources\views/Admin/pages/service/service.blade.php ENDPATH**/ ?>