...
?>
<script>
    var url_submit_contact = "<?php echo e(route('guest_insert_contact')); ?>";
    var getIP = "<?php echo $_SERVER['REMOTE_ADDR']?>'";

</script>
<script src="<?php echo e(asset('app/guest/contact/contact.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Guest.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\teamcoder\www\trainning\infocare\resources\views/guest/pages/contact/contact.blade.php ENDPATH**/ ?>