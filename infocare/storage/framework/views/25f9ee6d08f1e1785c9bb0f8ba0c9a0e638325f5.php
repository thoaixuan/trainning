        ...
        <div class="container clearfix">
            ...
            <div class="header-inner clearfix d-lg-flex">
                <div class="logo-outer">
                    <div class="logo"><a href="<?php echo e(route('guest_home')); ?>"><img src="<?php echo e(route('guest_home')); ?>/themes/guest/img/logo.png" alt="" title=""></a></div>
                    <div class="fixed-logo"><a href="<?php echo e(route('guest_home')); ?>"><img src="<?php echo e(route('guest_home')); ?>/themes/guest/img/logo.png" alt="" title=""></a></div>
                </div>
...
<!--==================================================================== 
                    End header area
=====================================================================-->
<?php /**PATH C:\teamcoder\www\trainning\infocare\resources\views/Guest/includes/header.blade.php ENDPATH**/ ?>