    ...
    <div class="container-lg">
        <div class="row justify-content-center authentication authentication-basic align-items-center h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                ...
                <form action="" method="" class="card custom-card" id="login-form">
                    @csrf
                    <div class="card-body p-5">
                        ...
                        <div class="text-center">
                            <p class="text-muted mt-3">Bạn chưa có tài khoản? <a href="#" class="text-primary">Đăng ký</a></p>
                        </div>
                    </div>
                </form>
            </div>
...
@endsection
@section('js')
<script src="{{ asset('app/login/megasetup.js') }}"></script>
{{-- <script type="module" src="{{ asset('app/login/loginmega.mjs') }}"></script> --}}
@endsection
