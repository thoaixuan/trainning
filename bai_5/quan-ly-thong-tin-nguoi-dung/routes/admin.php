...
Route::prefix('admin')->middleware('checkLogin')->group(function () {
    ...
    Route::prefix('room')->group(function(){
        ...
        Route::get('/insert-room',[RoomController::class,'getUpdate'])->name('admin.get_insert.room')->middleware('checkPermission:room-add');
    ...
    Route::prefix('role')->group(function(){
        ...
        Route::get('/insert-role',[RoleController::class,'getUpdate'])->name('admin.get_insert.role')->middleware('checkPermission:role-add');
