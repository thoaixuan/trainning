	...
	<div class="screen">
		<div class="screen__content">
            ...
            <div style="margin: 10px 5px">
                <span class="text-center" style="color: red;"><?php echo e(session('mess')); ?></span>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.signin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\trainning\bai_5\quan-ly-thong-tin-nguoi-dung\resources\views/admin/pages/signin/signin.blade.php ENDPATH**/ ?>