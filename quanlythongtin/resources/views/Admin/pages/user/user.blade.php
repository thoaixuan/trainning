          ...
          <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group text-right">
                    <button type="button" id="userExportPDF" class="btn btn-primary mr-2"><i class="far fa-file-pdf mr-1"></i> Xuất PDF</button>
                    <button type="button" class="btn btn-success" id="btn-insert"><i class="fa fa-plus mr-1" aria-hidden="true"></i> Thêm Mới</button>
                </div>
              </div>
          </div>
