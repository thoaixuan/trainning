	...
	<ul class="navbar-nav ml-2">
		...
		<li class="nav-item dropdown">
			<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle active"> 
        		<b> <span id="full_name_text_header">{{ Auth::user()->name }} </span> </b>
			</a>
		
			<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
				<li>
					<a href="{{ route('logout') }}"  class="dropdown-item" class="nav-link" role="button"> <i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
				</li>
			</ul>
		</li>	
	</ul>
