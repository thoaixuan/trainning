                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap border-bottom" id="contact-datatable">
                                </table>
                            </div>
                        </div>
                    </div>
...
<script>
  var contact=new contact();
        contact.datas={
        routes:{
          datatable:"{{route('admin.contact.getDatatable')}}",
          change_status:"{{route('admin.contact.changeStatus')}}",
