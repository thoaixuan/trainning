...
<head>
	...
	<!-- Plugins CSS -->
    <link href="{{ asset('themes/admin/assets/css/plugins.css')}}" rel="stylesheet">

    <!--- FONT-ICONS CSS -->
    <link href="{{ asset('themes/admin/assets/css/icons.css')}}" rel="stylesheet">

    <!-- INTERNAL Switcher css -->
    <link href="{{ asset('themes/admin/assets/switcher/css/switcher.css')}}" rel="stylesheet">
    <link href="{{ asset('themes/admin/assets/switcher/demo.css')}}" rel="stylesheet">
