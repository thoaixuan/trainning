        ...
        <div class="container clearfix">
            ...
            <div class="header-inner clearfix d-lg-flex">
                <div class="logo-outer">
                    <div class="logo"><a href="{{route('guest_home')}}"><img src="{{route('guest_home')}}/guest/img/logo.png" alt="" title=""></a></div>
                    <div class="fixed-logo"><a href="{{route('guest_home')}}"><img src="{{route('guest_home')}}/guest/img/logo.png" alt="" title=""></a></div>
                </div>
