...
<!-- CkEditor -->
<script src="<?php echo e(asset('admin/plugins/ckeditor/ckeditor.js')); ?>"></script><?php /**PATH C:\laragon\www\search-infocare\resources\views/admin/includes/stylesheet.blade.php ENDPATH**/ ?>