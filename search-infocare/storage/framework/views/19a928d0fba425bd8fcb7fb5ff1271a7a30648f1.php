            ...
            <div class="col-md-12">
                <table class="table table-bordered hover table-hover table-striped" id="table-users">
                    <thead>
                        ...
                        <tbody>
                        <?php $__currentLoopData = $pages_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pages_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          <td><?php echo e($pages_list->pages_name); ?></td>
                          <td><?php echo e($pages_list->pages_slug); ?></td>
                          <td><?php echo $pages_list->pages_content; ?></td>
                          <td>
                            <button onclick="idEdit('<?php echo e($pages_list->pages_name); ?>','<?php echo e($pages_list->pages_content); ?>','<?php echo e($pages_list->pages_slug); ?>',<?php echo e($pages_list->id); ?>)"
                              type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit">
                              <i class="fas fa-edit"></i>
                            </button>
                            <button type="button" class="btn btn-danger">
                              <a href="<?php echo e(url('admin-cpanel/pages/delete')."/".$pages_list->id); ?>" class="text-light"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </button>
                          </td>
                        </tr>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo e(route('page-add')); ?>" method="post">
              <?php echo csrf_field(); ?>
            <div class="form-group">
...
<?php $__env->stopSection(); ?>
  ...
  <!-- /.content -->
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\search-infocare\resources\views/admin/pages/pages/pages.blade.php ENDPATH**/ ?>