            ...
            <div class="col-md-12">
                <table class="table table-bordered hover table-hover table-striped" id="table-services">
                    <thead>
                        ...
                        <tr>
                          <td><?php echo e($services_list->services_name); ?></td>
                          <td><?php echo e($services_list->services_description); ?></td>
                          <td><?php echo e($services_list->services_slug); ?></td>
                          <td>
                            <button onclick="idEdit('<?php echo e($services_list->services_name); ?>','<?php echo e($services_list->services_description); ?>','<?php echo e($services_list->services_slug); ?>',<?php echo e($services_list->id); ?>)"
                              type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit">
                              <i class="fas fa-edit"></i>
                            </button>
                            <button type="button" class="btn btn-danger" id="btn-delete"
                            data-url="<?php echo e(route('service-delete')."/".$services_list->id); ?>">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="" data-url="<?php echo e(route('service-add')); ?>" id="form-add" method="post">
              <?php echo csrf_field(); ?>
            <div class="form-group">
...
<?php $__env->stopSection(); ?>
  ...
  <!-- /.content -->
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\search-infocare\resources\views/admin/pages/services/services.blade.php ENDPATH**/ ?>